                ...
                <div class="col-xs-12">
                    <div class="panel panel-oga">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a class="btn btn-default btn-3d" href="<?php echo site_url('Pre_sales/show_visitor'); ?>" role="button" style="color:none;margin-top: 65px;padding: 5px 35px;">
                        ...
                        <div class="panel-body">
                            <i class="fa fa-handshake-o fa-5x"></i><span style="font-size: 52px;"> Pre-Sales</span>
                        </div>
                    </div>

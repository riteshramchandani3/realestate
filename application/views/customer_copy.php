    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <p>
                                        ...
                                        Type : Duplex (Ground+First) Floor Only, at <?php echo $project_name . nbs(1) . $block; ?> to 
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#toppageheader').html('Possession Set Customer Copy<span class="pull-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="print" id="btnprint" value="print" class="btn btn-sm btn-default" onClick="print_this_doc();">Print&nbsp;&nbsp;<i class="fa fa-print"></i></button></span>');
                $("a:contains(Customer Copy)").parent().addClass('active');
            });

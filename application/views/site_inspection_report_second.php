...
<html>
    ...
    <head>
        <title>Site Inspection Report II</title>
        <?php
    ...
    <body>
        ...
        <div class="main">
            <div class="container">
                ...
                $userid = $listing[1];
                $unit_no = $listing[2];
                $doc_type = 'Site Inspection Report II';
                        ...
                        <form class="form-inline" action="" method ="post">
                            <div class="row">
                                <div class="col-xs-12 ">
                                    <p class="text-center">
                                        <b>
                                            Hkou /kkjd }kjk its'ku iwoZ lkbZV bathfu;j ds lkFk la;qDr :i ls fd;s x;s <br>
                                            fujh{k.k dk izek.k i= A
                                        </b>
                                    </p> 
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xs-5">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width:165px;">ehVj Øa- %</td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>ehVj jhfMax %</td>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <p>
                                        eS <span style="font-family: Titillium;">
                                            <select name="son_doughter_wife">
                                        ...
                                        izekf.kr djrk gwa fd vkt fnukad ------------------------ dks eSus vkoafVr edku ua- <span style="font-family:Titillium;"><?php echo $unit_no; ?></span> izkstsDV ,Llkjth laink esa tkWp gsrq fofHkUu dk;ksZ dk voyksdu lkbZV bapktZ@bathfu;j Jh <span style="font-family: Titillium;">
                                            <select style="font-family: Titillium;" id="selcat" name="category_select"  > 

                                            </select>

                                            &nbsp;
                                        </span> ds lkFk la;qDr :i ls fd;k gSA bu lHkh  dk;ksZ dk fooj.k ,oa fLFkfr fuEukuqlkj gS %&
                                    </p>
                                    <br>
                                    <table class="table table-bordered">
                                        <thead>
                                    ...
                                    <br>
                                    <p>
                                        mijksDrkuqlkj voyksdu ds vk/kkj ij iqu% eSa izekf.kr djrk gwa fd its'ku ysus gsrq esjs edku ,oa dkWyksuh ds fodkl ds lHkh dk;Z vuqca/kkuqlkj larks"ktud gS rFkk daiuh }kjk eq>s edku its'ku nsus ds lanHkZ esa vko';d dk;Zokgh dh tkos rkfd eSa Hkou dk okLrfod its'ku izkIr dj ldwa A                                </p>
                                    <br>
                                    <div class="row">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#toppageheader').html('Site Inspection Report II <span class="pull-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="print" id="btnprint" value="print" class="btn btn-sm btn-default" onClick="print_this_doc();">Print&nbsp;&nbsp;<i class="fa fa-print"></i></button></span>');
                $("a:contains(Site Inspection Report II)").parent().addClass('active');

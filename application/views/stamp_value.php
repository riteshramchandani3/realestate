...
<html>
    ...
    <head>
        <title>Stamp Value Purpose - Undertaking</title>
        <?php
    ...
    <body>
        ...
        <div class="main">
            <div class="container">
                ...
                $userid = $listing[1];
                $unit_no = $listing[2];
                $doc_type = 'Stamp Value Purpose Undertaking';
                        ...
                        <form class="form-inline" action="<?php echo site_url('Allotment_letter/search_id'); ?>" method ="post">
                            <div class="row">
                                <div class="col-xs-12 text-center">
                                    ...
                                    <br>
                                    <h4 style="margin-top: -22px;">Purpose - Undertaking</h4>
                                </div>
                            </div>
                            <br>
                            <div class="row">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#toppageheader').html('Stamp Value Purpose - Undertaking <span class="pull-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="print" id="btnprint" value="print" class="btn btn-sm btn-default" onClick="print_this_doc();">Print&nbsp;&nbsp;<i class="fa fa-print"></i></button></span>');

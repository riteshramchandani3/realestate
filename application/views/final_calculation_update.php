                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <label>&nbsp;&nbsp;&nbsp;<?php echo $unit_cost1; ?></label>

                                        <input class="form-control" type="hidden" step="0.01" min="0"  id="unit_cost1" name="unit_cost1"  value="<?php echo number_format((float) $unit_cost1, 2, '.', ''); ?>" >
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input class="form-control" type="text" step="0.01" min="0"  onblur="makedecimal(this.id)" id="maintiance_charge" name="maintiance_charge"  value="<?php echo number_format((float) $maintiance_charge, 2, '.', ''); ?>" onkeypress="return isNumberKey(event)" onkeyup="input0(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input type="text" step="0.01" min="0" onblur="makedecimal(this.id)"  id="monthly_operation" name="monthly_operation" value="<?php echo number_format((float) $monthly_operation, 2, '.', ''); ?>" class="form-control" onkeypress="return isNumberKey(event)" onkeyup="input1(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <!--td colspan="1"-->                                 
                                        <input type="hidden" step="0.01" min="0" onblur="makedecimal(this.id)" class="form-control" name="society_common" value="<?php echo number_format((float) $society_common, 2, '.', ''); ?>" id="society_common" onkeypress="return isNumberKey(event)" onkeyup="input2(this.value)">
                                    <!--/td-->                               
                                </tr>
                                <tr>                              
                                    <!--td colspan="3">
                                    ...
                                    <!--td colspan="1"-->                                 
                                        <input type="hidden" step="0.01" min="0" onblur="makedecimal(this.id)" class="form-control" name="society_membership_charges" value="<?php echo number_format((float) $society_membership_charges, 2, '.', ''); ?>"  id="society_membership_charges" onkeypress="return isNumberKey(event)" onkeyup="input11(this.value)">
                                    <!--/td-->                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input id="registration_stamp" onblur="makedecimal(this.id)" type="text" step="0.01" min="0" name="registration_stamp"  value="<?php echo number_format((float) $registration_stamp, 2, '.', ''); ?>" class="form-control" onkeypress="return isNumberKey(event)"  onkeyup="input3(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input type="text" step="0.01" onblur="makedecimal(this.id)" min="0" id="service_tax1" class="form-control" name="service_tax1" value="<?php echo number_format((float) $service_tax1, 2, '.', ''); ?>" onkeypress="return isNumberKey(event)"  onkeyup="input4(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input type="text" step="0.01"  onblur="makedecimal(this.id)" min="0" id="service_tax2" class="form-control" name="service_tax2" value="<?php echo number_format((float) $service_tax2, 2, '.', ''); ?>" onkeypress="return isNumberKey(event)" onkeyup="input5(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input  id="service_tax3" type="text" onblur="makedecimal(this.id)" step="0.01" min="0" class="form-control" name="service_tax3" value="<?php echo number_format((float) $service_tax3, 2, '.', ''); ?>" onkeypress="return isNumberKey(event)" onkeyup="input6(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input id="service_tax4" type="text" onblur="makedecimal(this.id)" step="0.01" min="0" class="form-control" name="service_tax4" value="<?php echo number_format((float) $service_tax4, 2, '.', ''); ?>" onkeypress="return isNumberKey(event)" onkeyup="input7(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input id="service_tax5" type="text" onblur="makedecimal(this.id)" step="0.01" min="0" class="form-control" name="service_tax5" value="<?php echo number_format((float) $service_tax5, 2, '.', ''); ?>" onkeypress="return isNumberKey(event)" onkeyup="input8(this.value)">
                                    </td>                               
                                </tr>
                                ...
                                <tr>                              
                                    ...
                                    <td colspan="1">                                 
                                        <input id="interest" type="text" step="0.01" onblur="makedecimal(this.id)" min="0" class="form-control" name="interest" value="<?php echo number_format((float) $interest, 2, '.', ''); ?>" onkeypress="return isNumberKey(event)"  onkeyup="input9(this.value)">
                                    </td>                               
                                </tr>

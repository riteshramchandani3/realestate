        ...
        <div class="main">
            <div class="container">
                ...
                if ($pdf != 'error') {
                    ...
                    <?php
                    foreach ($this->Agreement_model->get_RoadDevelopmentandSurfaceDrainNetwork($unit_no) as $row) {
                        ?>
                        <strong> <?php $RoadDevelopmentandSurfaceDrainNetwork = $row->payable_amt; ?></strong>
                    <?php } ?> 
                    <?php foreach ($this->Agreement_model->get_Electrical_Work($unit_no) as $row) {
                        ?>
                        <strong> <?php $Electrical_Work = $row->payable_amt; ?></strong>
                    <?php } ?> 
                    <?php foreach ($this->Agreement_model->get_Sewer_Line_Network($unit_no) as $row) {
                        ?>
                        <strong> <?php $Sewer_Line_Network = $row->payable_amt; ?></strong>
                    <?php } ?> 
                    <?php foreach ($this->Agreement_model->get_WaterSupplyandGardenNetwork($unit_no) as $row) {
                        ?>
                        <strong> <?php $WaterSupplyandGardenNetwork = $row->payable_amt; ?></strong>
                    <?php } ?> 
                    ...
                    <div id="printable">
                        ...
                        <form class="form-inline">
                            ...
                            <div class="row">
                                <u>   <h3 style="text-align: center;">AGREEMENT FOR SALE OF RESIDENTIAL PLOT (<?php echo $project_name ?> <?php echo $block ?>)</h3></u>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p class="text-justify"><?php
                                        ...
                                        case may be], having its registered office at Essarjee House,                                       
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            ...
                                            <P>
                                                ...
                                                The Allottee had applied for a Residential plot in the <strong><?php echo $project_name; ?> <?php echo $block; ?></strong> vide application no. <strong><?php echo $customer_id; ?></strong>  dated <strong><?php
                                                    $x = explode(' ', $checkdate);
                                                    $checkdate = new DateTime($x[0]);
                                                    //echo $checkdate->format('d-m-Y');
                                                    ?></strong> 
                                                and has been allotted Residential plot no. <STRONG><?php echo $unit_no ?></STRONG> having area ofrong>(<?php echo $length_m; ?> Mtr. x <?php echo $width_m; ?> Mtr.) = <?php echo $plot_area; ?> Sq. Mtr.</strong>
                                                square Meter will have parking / porch within the plot boundary as applied / permitted /
                                                approved by Municipal Corporation Bhopal within law and no additional space shall be provided 
                                                by the Promoter for individual car parking, as permissible under the applicable law and of pro 
                                                rata share in the common areas (“Common Areas”) as defined under clause (n) of Section 2 of the 
                                                Act (hereinafter referred to as the “Plot” more particularly described in Schedule A and the 
                                                demarcation layout of the plot is annexed hereto and marked as Schedule B); 
                                    ...
                                    <div class="row" style="color:#000">
                                        ...
                                        <div class="col-xs-11">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-11">
                                                    <p>
                                                        That the allottee has to take the Building permission from the Municipal Corporation Bhopal at his own expenses and shall strictly abide with the building permission given by the Municipal Corporation Bhopal. After completion of the construction work it is the sole responsibility of the allottee to obtain completion certificate from the Municipal Corporation Bhopal at his own expenses. 
                                                    </p>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-11">
                                                    <p>
                                                        That it is the sole responsibility of allottee to pay the property tax and diversion rent etc., which will be levied on the Allottee from the date of registry/Conveyance deed of the plot in favor of the Allottee by the promoter                                            
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-11">
                                                    <p>
                                                        Installation of the individual electric meter / water meter as applicable shall be the responsibility of the allottee.                                        
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-11">
                                                    <p>
                                                        The Allottee has to deposit the Monthly operational charges as decided and demanded by society / residents’ welfare association / Promoter (as the case may be) as soon as the construction on the plot is completed by allottee after taking the Building permission from the Municipal Corporation Bhopal.                                  
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-11">
                                                    <p>
                                                        That the allottee has to make provisions for the use of Treated water in his residential plot/unit in his built up residential unit as the promoter has installed the Dual Plumbing network for the reuse of recycled water in the project and for the purpose of construction the allottee shall use tanker water.                                   
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            ...
                                            <p>
                                                In accordance with the terms and conditions set out in this Agreement and as mutually agreed upon by 
                                                and between the Parties, the Promoter hereby agrees to sell and the Allottee hereby agrees to purchase 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                The Total Price for the Residential Plot No. <strong><?php echo $unit_no ?></strong>  
                                                is  Rs.<?php echo $total_cost; ?><input type="hidden" id="bookingAmountseven" value="<?php echo $total_cost; ?>">(Rupees <span id='wordbookingAmountseven' style="height:20px; width:auto; font-weight:bold;"></span> only ("Total Price") 
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <table class="table table-bordered">
                                                <thead class="thead-inverse">
                                                    <tr>
                                                        <th style="text-align:center;"> Rate of Residential Plot No. <strong><?php echo $unit_no ?></strong>  per SQM</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                            ...
                                            <table class="table table-bordered ">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="text"  value="<?php echo number_format((float) $basic_cost_ref_rate, 2, '.', ''); ?>"  style="width: 150px; border: none; background-color: white;" disabled/></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
                                                        ...
                                                        <td><input  value="<?php echo number_format((float) $corner_charges + $garden_facing_charges, 2, '.', ''); ?>"  style="width: 150px; border: none; background-color: white;" disabled/></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">3</th>
                                                        <td>Other fixed charges
                                                        </td>
                                                        ...
                                                        <td><input  value="<?php echo number_format((float) $mpseb_cost_ref_rate, 2, '.', ''); ?>"  style="width: 150px; border: none; background-color: white;" disabled/></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
                                                        ...
                                                        <td><input  value="-"  style="width:150px; border: none; background-color: white;" disabled/></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input  value="<?php echo $maintenance_cost_ref_rate ?>"  style="width:150px; border: none; background-color: white;" disabled/></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b><?php echo number_format((float) $water_connection_ref_rate, 2, '.', ''); ?></b></td>
                                                    </tr>
                                                    <tr> 
                                                        <th scope="row">7</th>
                                                        <td>Discount</td>
                                                        ...
                                                        <td><b><?php echo number_format((float) $discount, 2, '.', ''); ?></b></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">8</th>
                                                        ...
                                                        <td><b><?php //echo number_format((float) $cost_wash_area, 2, '.', '');      ?></b></td>
                                                        <td><b><?php //echo number_format((float) $cost_washarea_ref_rate, 2, '.', '');       ?></b></td>
                                                        <td><b><?php echo number_format((float) $total_cost, 2, '.', ''); ?></b></td>
                                                    </tr>
                                                </tbody>
                                            </table>                                                                      
                                        </div>
                                    ...
                                    <div class="row">
                                        <p>Provided that the amounts mentioned under the heads, Taxes, Maintenance Charges, Any Extra Charge for Amenities/Facilities, 
                                            Service Charges and other heads of like nature, shall not be taken into account, while determining the Market Value of the said Plot for the 
                                            purpose of calculation of the Stamp Duty, Registration Charges and any other incidental expenses, for the execution and registration of this Agreement to Sale or the Conveyance/Sale Deed 
                                            to be executed in future, with respect to the said Plot.</p>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                The Total Price above includes the booking amount paid by the allottee to the Promoter towards the Plot; 
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                ...
                                                The Total Price above includes Taxes (consisting of tax paid or payable by the Promoter by way of GST) 
                                                up to the date of handing over the possession of the plot to the allottee and the project to the 
                                                association of allottees or the competent authority, as the case may be, after obtaining the 
                                            ...
                                            <p>
                                                ...
                                                Provided further that if there is any increase in the taxes after the expiry of the scheduled date of completion of the project as per registration with the Authority, which shall 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>                                                                       
                                                The Promoter shall periodically intimate in writing to the Allottee, the amount payable as stated 
                                                in (i) above and the Allottee shall make payment demanded by the Promoter within the time and in the manner specified therein. In addition, 
                                                the Promoter shall provide to the Allottee the details of the taxes paid or demanded along with the acts/rules/notifications together with dates from which such taxes/levies etc. have been imposed or become effective; 
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>                                                                       
                                                The Total Price of Plot includes recovery of price of land, external development charges like External Electrification, Roads, Gardens, Sump-well, 
                                                Water line network up to the plot,  External sewer line network including STP, drainage system, 
                                                taxes, maintenance charges as per para 11 and other common facilities and amenities of the Project if/as applicable.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                ...
                                                in respect of thein respect of the Residential Plot, as the case may be, without the
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                The Promoter shall confirm to the final Plot area that has been allotted to the Allottee 
                                                after the development of the plot is complete and the completion certificateis granted by 
                                                the competent authority, by furnishing details of the changes, if any, in the Plot area. 
                                                The total price payable for the Plot area shall be recalculated upon confirmation by the
                                                Promoter. If there is reduction in the Plot area then the Promoter shall refund the excess
                                                money paid by Allottee within forty-five days with annual interest at the rate prescribed 
                                                in the Rules, from the date when such an excess amount was paid by the Allottee. If there
                                                is any increase in the Plot area, which is not more than three percent of the Plot area of 
                                                the plot, allotted to Allottee, the Promoter may demand that from the Allottee as per the 
                                                next milestone of the Payment Plan as provided in Schedule C. All these monetary adjustments 
                                                hall be made at the same rate per square feet as agreed in para 1.2 of this Agreement.
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                Subject to para 9.3 the Promoter agrees and acknowledges, the Allottee shall have the right to the 
                                                Residential Plot No. <strong><?php echo $unit_no ?></strong> as mentioned below:
                                            </p>
                                            <div class="col-xs-1">
                                                (i)
                                            </div>
                                            <div class="col-xs-11">
                                                <p>
                                                    The Allottee shall have exclusive ownership of the <span style="color:#000">Row House 
                                                        plot no    <strong><?php echo $unit_no; ?></strong></span>;
                                                </p>
                                            ...
                                            <div class="col-xs-11">
                                                <p>
                                                    That the computation of the price of the Residential Plot No. <strong><?php echo $unit_no ?></strong> includes recovery of price of land, external
                                                    development charges like External Electrification, Roads, Gardens, Water line network up to the 
                                                    plot,  External sewer line network including STP, drainage system, taxes, maintenance charges as
                                                    per para 11 and the cost of other common facilities and amenities of the Project if/as 
                                                    applicable to be provided within the Project;
                                                </p>
                                            </div>
                                            <div class="col-xs-1">
                                                (iv)
                                            ...
                                            <div class="col-xs-11">
                                                <p>
                                                    ...
                                                    the project and his Residential Plot unit, as the case may be. 
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                ...
                                                Plot No. <strong><?php echo $unit_no ?></strong>  will have parking / porch within the plot boundary as applied / 
                                                permitted / approved by Municipal Corporation Bhopal within law and no additional 
                                                space shall be provided by the Promoter for individual car parking. 
                                                It is agreed that this Project<strong>
                                                    <label><?php echo $project_name; ?>  <?php echo $block; ?></label></strong>  is a part of Main Project
                                                Essarjee Sampada which is in three phases namely Phase – 1 which is already
                                                completed, Phase - 2 which is in ongoing state and phase - 3 which is proposed 
                                                to start later on. A part of this  the <strong><label><?php echo $project_name; ?> <?php echo $block; ?>
                                                    </label></strong>  is a self-contained 
                                                Project covering the said Land and is not a part of any other neighboring project 
                                                or zone and shall not form a part of and/or linked/combined except the connectivity
                                                of the road to the Adjoining/neighborhood land as per the rules of Town & Country
                                                Planning   with any other project in its vicinity or otherwise except for the 
                                                purpose of integration of infrastructure for the benefit of the Allottee Or for 
                                                the purpose of right of way / approach to any other part. It is clarified that 
                                                Project’s common facilities and amenities shall be available only for use and 
                                                enjoyment of the Allottees of all the three phases of the Essarjee Sampada
                                                Project including the residents of EWS, LIG and MIG units.
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p> The Promoter agrees to pay all outgoings before transferring the
                                                physical possession of the Row House Plot no <strong> <?php //echo $unit_no;                          ?></strong>  to the Allottees, which it has collected from 
                                                ...
                                                before transferring the plot  to the Allottees, the Promoter agrees to be liable, even 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                The Allottee has paid a sum of Rs.  <?php echo $customer_booking_amt; ?><input type="hidden" id="bookingAmountsix"  value="<?php echo $customer_booking_amt; ?>"/> (Rupees <span id='wordbookingAmountsix' style="height:20px; width:auto; font-weight:bold;"></span> only/-)  as booking amount being part 
                                                payment  towards the Total Price of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  at the time of application. 
                                                The receipt of which the Promoter hereby acknowledges and the Allottee hereby agrees
                                                to pay the remaining price of the Residential Plot No.<strong><?php echo $unit_no ?></strong>  as prescribed in the Payment Plan [Schedule C] as may be demanded 
                                                by the Promoter within the time and in the manner specified therein: Provided that if the allottee delays in payment towards any amount
                                                which is payable, he shall be liable to pay interest at the rate based on the State Bank of India highest marginal cost of lending rate ………… plus 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                ...
                                                in favour of ‘Essarjee Constructions Private Limited.’ payable at 
                                                Bhopal. 
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                The Allottee authorizes the Promoter to adjust/appropriate all payments made by him/her under any head(s) of 
                                                dues against lawful outstanding of the allottee against the Residential Plot No. <strong><?php echo $unit_no ?></strong>  
                                                if any, in his/her name and the Allottee undertakes not to object/demand/direct the Promoter to 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p class="text-justify">
                                                The Promoter shall abide by the time schedule for completing the project as disclosed at the time of registration of the
                                                project with the Authority and towards handing over the Residential Plot No. <strong><?php echo $unit_no ?></strong>  to the 
                                                Allottee and the common area / amenities and facilities to the association of allottees or the
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <label>
                                                POSSESSION OF THE RESIDENTIAL PLOT UNIT.
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                Schedule for possession of the said Residential Plot No.<strong><?php echo $unit_no ?></strong>  - The Promoter agrees 
                                                and understands that timely delivery of possession of the Residential Plot No. <strong><?php echo $unit_no ?></strong> to 
                                                the allottee and the common areas, amenities and facilities to the association of allottees 
                                                or the competent authority, as the case may be, is the essence of the Agreement. 
                                                The Promoter assures to hand over possession of the Residential 
                                                Plot No. <strong><?php echo $unit_no ?></strong>  along with ready and complete common area,of the project in place on 
                                                (date to be specified) _________________, unless there is delay or failure due to war, 
                                                ...
                                                of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  provided that such Force Majeure conditions
                                                are not of a nature, which make it impossible for the contract to be implemented. 
                                                The Allottee agrees and confirms that, in the event it becomes impossible for the Promoter
                                                to implement the project due to Force Majeure conditions, then this allotment shall stand 
                                                terminated and the Promoter shall refund to the Allottee the entire amount received by the 
                                                Promoter from the allotment within 45 days from that date. The promoter shall intimate the 
                                                ...
                                                shall not have any rights, claims etc. against the Promoter and that the Promoter 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p class="text-justify">
                                                Procedure for taking possession - The Promoter, upon obtaining full and final payment from the allottee & 
                                                the completion certificate* from the competent authority shall offer in writing the possession
                                                of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  to the Allottee in terms of this Agreement to be taken 
                                                within two months from the date of issue of completion certificate. [Provided that, in the
                                                absence of local law, the conveyance deed in favour of the allottee shall be carried out by
                                                the promoter within 3 months from the date of issue of completion certificate]. 
                                                The Promoter agrees and undertakes to indemnify the Allottee in case of failure of
                                                fulfillment of any of the provisions, formalities, documentation on part of the Promoter. 
                                                The Allottee, after taking possession, agree(s) to pay the maintenance charges as determined 
                                                by the Promoter/association of allottees, as the case may be after the issuance of the 
                                                completion certificate for the project. The promoter shall hand over the completion 
                                                certificate of the Residential Plot unit, as the case may be, to the allottee at the 
                                                time of conveyance of the same. That it shall be mandatory for the Allottee  to become
                                                a member of the residents society, at the time of possession of the said property, which 
                                                is already formed by the residents of <strong><?php echo $project_name; ?> <?php echo $block; ?></strong> and which shall be responsible 
                                                for all maintenance and security provision of the premises as may be mutually decided later.  
                                            </p>
                                        </div>
                                    </div><br><br>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                Failure of Allottee to take Possession of Residential Plot No. <strong><?php echo $unit_no ?></strong>  Upon receiving 
                                                a written intimation from the Promoter as per para 7.2, the Allottee shall take possession 
                                                of the Residential Plot No. <strong><?php echo $unit_no ?></strong> from the Promoter by executing necessary indemnities,
                                                undertakings and such other documentation as prescribed in this Agreement, and the Promoter
                                                shall give possession of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  to the allottee. 
                                                In case the Allottee fails to take possession within the time provided in para 7.2,
                                                such Allottee shall continue to be liable to pay maintenance charges as specified in 
                                                para 7.2. Also in the event of Allottee’s failure to take possession or getting 
                                                conveyance deed done in time limit, for any reason whatsoever, expenditure incurred 
                                                on the taking care and/or maintenance of the plot shall be charged extra at the rate
                                                of rupees thirty per sqm of the plot area plus taxes per month from the date onwards 
                                                other than external maintenance charges, and be paid by the purchaser as and when 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                ...
                                                over physical possession of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  to the Allottees, it shall
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                Compensation – The Promoter shall compensate the Allottee in case of any loss caused to him due 
                                                to defective title of the land, on which the project is being developed or has been developed, 
                                                in the manner as provided under the Act and the claim for interest and compensation under this 
                                                provision shall not be barred by limitation provided under any law for the time being in force.
                                                Except for occurrence of a Force Majeure event, if the promoter fails to complete or is unable to 
                                                give possession of the Residential Plot No. <strong><?php echo $unit_no ?></strong> <br> (i) in accordance with the terms of this Agreement, duly 
                                                completed by the date specified in para 7.1; or <br>(ii) due to discontinuance of his business as a developer on account 
                                                of suspension or revocation of the registration under the Act; or for any other reason; the Promoter shall be liable,
                                                on demand to the allottees, in case the Allottee wishes to withdraw from the Project, without prejudice to any other 
                                                remedy available, to return the total amount received by him in respect of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  with 
                                                interest at the rate prescribed in the Rules including compensation in the manner as provided under the Act within 
                                                forty-five days of it becoming due. Provided that where if the Allottee does not intend to withdraw from the Project,
                                                the Promoter shall pay the Allottee interest at the rate prescribed in the Rules for every month of delay, till the 
                                                handing over of the possession of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  which shall be paid by the promoter to the allottee
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>  There are no litigations pending before any Court of law or Authority with respect to 
                                                the said Land, Project or the Residential Plot No. <strong><?php echo $unit_no ?></strong> 
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>  All approvals, licenses and permits issued by the competent authorities with respect to 
                                                ...
                                                said Land, and Residential Plot No. <strong><?php echo $unit_no ?></strong>  and common area; 
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p> The Promoter has the right to enter into this Agreement and has not committed or omitted to perform 
                                                any act or thing, whereby the right, title and interest of the Allottee created herein, may prejudicially be affected;  
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>The Promoter has not entered into any agreement for sale and/or development agreement 
                                                or any other agreement / arrangement with any person or party with respect to the said Land, 
                                                including the Project and the said Residential Plot No. <strong><?php echo $unit_no ?></strong>  which will, in any manner, 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>The Promoter confirms that the Promoter is not restricted in any manner 
                                                whatsoever from selling the said Residential Plot No. <strong><?php echo $unit_no ?></strong>  to the 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p> At the time of execution of the conveyance deed the Promoter shall handover 
                                                lawful, vacant, peaceful, physical possession of the Residential 
                                                Plot No. <strong><?php echo $unit_no ?></strong>  to the Allottee and the common area, to the association 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                (xi) The Promoter has duly paid and shall continue to pay and discharge all governmental dues, rates, charges 
                                                and taxes and other monies, levies, impositions, premiums, damages and/or penalties and other 
                                                outgoings, whatsoever, payable with respect to the said project to the competent Authorities 
                                                till the completion certificate has been issued and possession of Residential
                                                Plot No. <strong><?php echo $unit_no ?></strong> , along with common area, (equipped with all the specifications, 
                                                amenities and facilities) has been handed over to the allottee and the association
                                                of allottees or the competent authority, as the case may be except for the property
                                                tax and diversion rent etc., which will be levied on the Allottee from the date of registry 
                                                of the row house in favour of the Allottee by the promoter or from the last date of payment
                                                as mentioned in the payment schedule whichever is earlier. 
                                            </p>
                                        </div>
                                    </div>                                                                                                       
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                (xii) No notice from the Government or any other local body or authority or any legislative enactment, government
                                                ordinance, order, notification (including any notice for acquisition or requisition of the
                                                said property) has been received by or served upon the Promoter in respect of the said Land
                                                and/or the Project pertaining to the legality of the project. 
                                            </p>
                                        </div>
                                    </div> <br><br>                                                                                                      
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                Promoter fails to provide ready to move in possession of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  
                                                to the Allottee within the time period specified in para 7.1 or fails to complete the project 
                                                within the stipulated time disclosed at the time of registration of the project with the Authority. 
                                                For the purpose of this para, 'ready to move in possession' shall mean that the Residential Plot 
                                                shall ready for construction after taking necessary building permission from Municipal Corporation, 
                                                Bhopal. The plot is complete in all respects including the provision of all specifications, amenities 
                                                and facilities, as agreed to between the parties, and for which completion certificate, has been issued 
                                    ...
                                    <div class="row">                                                       
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                ...
                                                the Agreement, he shall be paid, by the promoter, interest at the rate prescribed 
                                                in the Rules, for every month of delay till the handing over of the possession of 
                                                the Residential Plot No. <strong><?php echo $unit_no ?></strong> , which shall be paid by the promoter to the 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">                                                          
                                            <p>
                                                In case the Allottee fails to make payments for demands made by the Promoter as per the Payment Plan 
                                                annexed hereto, despite having been issued notice in that regard the allottee shall be liable to pay interest
                                                to the promoter on the unpaid amount at the rate based on the State Bank of India highest marginal cost of 
                                                lending rate ………… plus two percent (as on date of signing of the agreement) from their respective due dates. 
                                            </p>       
                                        </div>
                                        <div class="col-xs-1">
                                            (ii)
                                        ...
                                        <div class="col-xs-11">
                                            <p>
                                                (ii) In case of Default by Allottee under the condition listed above continues for a period beyond 2 consecutive
                                                months after notice from the Promoter in this regard, the Promoter may cancel the
                                                allotment of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  in favour of the Allottee and
                                                refund the money paid to him by the allottee by deducting the booking amount 
                                                or 10% of the total price of the plot, whichever is more and the interest liabilities and 
                                                this Agreement shall thereupon stand terminated. Provided that the promoter shall intimate the
                                                allottee about such termination at least thirty days prior to such termination.
                                            </p>
                                        </div>
                                    </div>

                                    <h4><b>10. CONVEYANCE OF THE SAID PLOT: </b></h4>
                                    <p class="text-justify">
                                        The Promoter, on receipt of Total Price of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  as 
                                        per para 1.2 under the Agreement from the Allottee, shall execute a conveyance 
                                        deed and convey the title of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  together with 
                                        proportionate indivisible share in the Common area, within 3 months from the 
                                        date of issuance of the the completion certificate, to the allottee. 
                                        [Provided that, in the absence of local law, the conveyance deed in 
                                        favour of the allottee shall be carried out by the promoter within 3 months 
                                        from the date of issue of Completion certificate]. However, in case the Allottee 
                                        fails to deposit the stamp duty and/or registration charges and mutation charges
                                        within the period mentioned in the notice, the Allottee authorizes the Promoter 
                                        to withhold registration of the conveyance deed in his/her favour until payment
                                        of stamp duty and registration charges and mutation charges to the Promoter is
                                        made by the Allottee. <br>
                                    ...
                                    <p class="text-justify">
                                        ...
                                        the Project until the taking over of the maintenance of the project by the 
                                        association of allottees upon the issuance of the completion certificate of 
                                        the project. The cost of such maintenance has been included in the Total Price 
                                        of the Residential Plot No. <strong><?php echo $unit_no ?></strong>   
                                    </p>
                                    ...
                                    <p class="text-justify">
                                        ...
                                        the agreement for sale relating to such development is brought to the notice of 
                                        the Promoter within a period of 5 (five) years by the Allottee from the date of 
                                        handing over possession of the plot, it shall be the duty of the Promoter to rectify such 
                                        defects without further charge, within 30 (thirty) days, and in the event of 
                                    ...
                                    <p class="text-justify">
                                        ...
                                        access of all Common Areas, for providing necessary maintenance services and the 
                                        Allottee agrees to permit the association of allottees and/or maintenance agency 
                                        to enter into the plot or any part thereof, after due notice and during the normal 
                                    ...
                                    <p class="text-justify">
                                        ...
                                        ESSARJEE Sampada Phase - 2, shall be earmarked for purposes such as parking 
                                        spaces and services including but not limited to electric sub-station, 
                                        transformer, DG set rooms, underground water tanks, pump rooms, maintenance 
                                        and service rooms, firefighting pumps and equipment’s etc. and other 
                                        permitted uses as per sanctioned plans. The Allottee shall not be permitted to 
                                        use the services areas and the basements in any manner whatsoever, other than 
                                        those earmarked as parking spaces, and the same shall be reserved for use by 
                                        the association of allottees formed by the Allottees for rendering maintenance 
                                        services.
                                    </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                Subject to para 12 above, the Allottee shall, after taking possession of 
                                                plot and during the course of construction the allottee shall ensure that; 
                                                (a) The common services provided at the project by promoter should not get 
                                                damaged or jeopardized. (b) The adjacent constructed units should not get 
                                                damaged or jeopardized. In case of any such damage the allottee agrees to 
                                                repair and maintain it to its original condition on its own cost and 
                                                expenditure. After completing the construction on the plot, the allotee 
                                                shall be solely responsible to maintain the Residential 
                                                Plot No. <strong><?php echo $unit_no ?></strong>  at his/her own cost, in good repair and 
                                                condition and shall not do or suffer to be done anything in or to the 
                                                adjacent units on either side and at back side of the Residential 
                                                Plot No. <strong><?php echo $unit_no ?></strong> , which may be in violation of any laws or rules of any 
                                                authority or change or alter or make additions to the Residential 
                                                Plot No. <strong><?php echo $unit_no ?></strong>  and keep the Residential Plot No. <strong><?php echo $unit_no ?></strong> , its walls 
                                                and partitions, sewers, drains, pipe and appurtenances thereto or belonging 
                                                thereto, in good and tenantable repair and maintain the same in a fit and 
                                                proper condition and ensure that the support, shelter etc. of the Residential 
                                                Plot No. <strong><?php echo $unit_no ?></strong>  And adjacent units on either side and at back side are 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                ...
                                                neon light, publicity material or advertisement material etc. on the face / 
                                                facade of the Residential Plot No. <strong><?php echo $unit_no ?></strong>   or anywhere on the exterior of 
                                                the Project, buildings therein or Common Areas. Further, the Allottee shall 
                                                not store any hazardous or combustible goods in the Residential 
                                                Plot No. <strong><?php echo $unit_no ?></strong>  or place any heavy material in the common area of the project. 
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                The Allottee shall plan and distribute its electrical load in conformity with the electrical 
                                                systems installed by the Promoter as per the sanctioned load by MPMKVVCL and 
                                                ...
                                                damages arising out of breach of any of the previously mentioned conditions. 
                                            </p>
                                        </div>
                                    </div>                                               
                                    <h4><b>16. COMPLIANCE OF LAWS, NOTIFICATIONS ETC. BY PARTIES: </b></h4>
                                    <p class="text-justify">
                                        The Parties are entering into this Agreement for the allotment of a Residential 
                                        Plot No. <strong><?php echo $unit_no ?></strong>  with the full knowledge of all laws, rules, regulations, notifications 
                                    ...
                                    <p class="text-justify">
                                        ...
                                        structure(s) anywhere in the Project after the development plan, layout plan, sanction 
                                        plan and specifications, amenities and facilities has been approved by the competent authority(is) 
                                        and disclosed, except for as provided in the Act.
                                    </p>
                                    <h4><b>18. PROMOTER SHALL NOT MORTGAGE OR CREATE A CHARGE:</b> </h4>

                                    <p class="text-justify">
                                        After the Promoter executes this Agreement he shall not mortgage or create a charge on the Residential 
                                        Plot No. <strong><?php echo $unit_no ?></strong>  and if any such mortgage or charge is made or created then
                                        notwithstanding anything contained in any other law for the time being in force,
                                        such mortgage or charge shall not affect the right and interest of the Allottee 
                                        who has taken or agreed to take such Plot.
                                    </p>
                                    <h4><b>19. OWNERSHIP ACT:</b> </h4>

                                    <p class="text-justify">
                                        The Promoter has assured the Allottees that the project in its entirety is in accordance 
                                        with the provisions of the Registration Act 1908. The Promoter showing compliance of various laws 
                                        / regulations as applicable in Registration Act 1908 and amendments, if any.
                                    </p>
                                    <h4><b>20. BINDING EFFECT: </b></h4>

                                    <p class="text-justify">
                                        Forwarding this Agreement to the Allottee by the Promoter does not create a 
                                        binding obligation on the part of the Promoter or the Allottee until, firstly, 
                                        the Allottee signs and delivers this Agreement with all the schedules along with
                                        ...
                                        the same before the concerned Sub-Registrar Bhopal, at ISBT Bhopal  as and when 
                                        intimated by the Promoter. If the Allottee(s) fails to execute and deliver to 
                                        the Promoter this Agreement within 30 (thirty) days from the date of its receipt
                                        by the Allottee and/or appear before the Sub-Registrar for its registration as 
                                        and when intimated by the Promoter, then the Promoter shall serve a notice to 
                                        the Allottee for rectifying the default, which if not rectified within 30 (thirty) 
                                        days from the date of its receipt by the Allottee, application of the 
                                        Allottee shall be treated as cancelled and all sums deposited by the Allottee 
                                        in connection therewith including the booking amount shall be returned to the 
                                    ...
                                    <p class="text-justify">
                                        ...
                                        TThis Agreement, along with its schedules, constitutes the entire Agreement between the Parties 
                                        with respect to the subject matter hereof and supersedes any and all understandings, any other agreements, 
                                        allotment letter, correspondences, arrangements whether written or oral, if any, between the Parties in 
                                        regard to the said plot/plot/building, as the case may be. 
                                    </p>
                                    ...
                                    <p class="text-justify">
                                        ...
                                        contained herein and the obligations arising hereunder in respect of the Residential Plot No. <strong><?php echo $unit_no ?></strong> 
                                        and the Project shall equally be applicable to and enforceable against and by any subsequent Allottees of 
                                        the Residential Plot No. <strong><?php echo $unit_no ?></strong> , in case of a transfer, as the said obligations go along with the Residential 
                                        Plot No. <strong><?php echo $unit_no ?></strong>  for all intents and purposes.
                                    </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11">
                                            <p>   
                                                The Promoter may, at its sole option and discretion, without prejudice to 
                                                its rights as set out in this Agreement, waive the breach by the Allottee in 
                                                not making payments as per the Payment Plan [Annexure C] including waiving the 
                                                payment of interest for delayed payment. It is made clear and so agreed by the 
                                                Allottee that exercise of discretion by the Promoter in the case of one Allottee shall not be construed to be a precedent and /or binding on the Promoter to exercise such discretion in the case of other Allottees.<br>
                                            </p>
                                        </div>
                                    </div> 
                                    <div class="row">
                                    ...
                                    <p class="text-justify">
                                        If any provision of this Agreement shall be determined to be void or unenforceable under the Act or the Rules
                                        and Regulations made there under or under other applicable laws, such provisions of the Agreement shall be 
                                        deemed amended or deleted in so far as reasonably inconsistent with the purpose of this Agreement and to the 
                                        extent necessary to conform to Act or the Rules and Regulations made there under or the applicable law, as 
                                        the case may be, and the remaining provisions of this Agreement shall remain valid and enforceable as 
                                    ...
                                    <p class="text-justify">
                                        ...
                                        in common with other Allottee(s) in Project, the same shall be the proportion which the Plot 
                                        area of the Residential Plot No. <strong><?php echo $unit_no ?></strong>  bears to the total Plot area of all the Residential 
                                    ...
                                    <p class="text-justify">
                                        ...
                                        agreed between the Promoter and the Allottee, in BHOPAL after the Agreement is duly executed by the
                                        Allottee and the Promoter or simultaneously with the execution the said Agreement shall be registered 
                                        at the office of the Sub-Registrar at ISBT, Bhopal. Hence this Agreement shall be deemed to have been 
                                        executed at BHOPAL. In case any additional stamp duty is required to be paid for the registration of 
                                        the Agreement for sale that shall be additionally borne by the Allottee.
                                    </p>
                                    ...
                                    <p class="text-justify">
                                        ...
                                        in respect of the Residential Plot No. <strong><?php echo $unit_no ?></strong>   prior to the execution and registration of this Agreement 
                                        for Sale for such Residential Plot No. <strong><?php echo $unit_no ?></strong>   shall not be construed to limit the rights and interests
                                        of the allottee under the Agreement for Sale or under the Act or the rules or the regulations made there
                                        under. 
                                    </p>
                                    <h4><b>
                                    ...
                                    <p class="text-justify">
                                        ...
                                        and enforced in accordance with the Act and the Rules and Regulations made there under including other
                                        applicable laws of India for the time being in force. In the matters falling beyond the jurisdiction of 
                                        the Authority and/or Real Estate Regulatory Tribunal, the Courts of Law in Bhopal will have exclusive 
                                    ...
                                    <p class="text-justify">
                                        ...
                                        <strong>  SCHEDULE 'A'</strong> -DESCRIPTION OF THE Residential Plot <?php echo $unit_no ?> ALONG WITH BOUNDARIES IN ALL FOUR DIRECTIONS.<br>

                                        <strong> SCHEDULE 'B'</strong> -LAYOUT OF THE PLOT.<br>

                                        <strong>    SCHEDULE 'C' </strong>-PAYMENT PLAN.<br>

                                        <strong>    SCHEDULE 'D'</strong> -Schedule is Not applicable for plot sale<br>
                                    ...
                                    <p class="text-justify">
                                        That the property known as Residential Plot No. <strong><?php echo $unit_no ?></strong>  admeasuring <strong> <?php echo $length_m; ?></strong>  Mtr. X  <strong><?php echo $width_m; ?> Mtr.</strong> = Plot area <strong><?php echo number_format((float) $plotft = $length_m * $width_m, 2, '.', ''); ?></strong>
                                        Sq. Mt. (<strong><?php echo number_format((float) $length_m * $width_m * 10.76, 2, '.', ''); ?></strong> Sq. Ft.) will have parking / porch within the plot boundary as applied / permitted / approved 
                                        by Municipal Corporation Bhopal within law no additional space shall be provided by the Promoter for 
                                        individual car parking, on Khasra No. 824/1, 825/2, 828/1/2, 816, 827/1, 825/1/क 825/1/ख 828/1/1/ख 
                                        & 827/2 having total area of land is 88,455.94 Sq. Mt. (9,51,786.00 Sq. Fts.) / (8.842 Hectare) / (21.85 Acres)  
                                        situated at Village Khajurikalan, in, Tehsil – Huzur & District Bhopal within the limits of Bhopal Municipal 
                                        Corporation Ward No. 62 and Plot boundaries are as under.
                                        The boundaries of Plot <strong><?php echo $unit_no; ?></strong> are as under:<br>
                                    ...
                                    <p class="text-justify">
                                        ...
                                        That the total cost of the  Residential Plot No.  <strong><?php echo $unit_no; ?></strong>
                                    ...
                                    <ol style="text-align:justify;">
                                        <li>
                                            That the 10% of the agreement cost i.e. Rs. <?php echo $RoadDevelopmentandSurfaceDrainNetwork; ?> <input type="hidden" id="bookingAmountOne"  value="<?php echo $RoadDevelopmentandSurfaceDrainNetwork; ?>"/> (Rupees <span id='wordbookingAmountOne' style="height:20px; width:auto; font-weight:bold;"></span> only/-) shall be deposited as booking amount 
                                            out of which allottee has paid Rs.<input type="hidden" id="bookingAmounttwo" value="<?php echo $customer_booking_amt; ?>"><?php echo $customer_booking_amt; ?>(Rupees <span id='wordbookingAmounttwo' style="height:20px; width:auto; font-weight:bold;"></span> only/-) vide 
                                            cheque/DD/NEFT/RTGS No <?php echo $cheque_no; ?>dated <?php
                                            $x = explode(' ', $checkdate1);
                                            $checkdate1 = new DateTime($x[0]);
                                            echo $checkdate1->format('d-m-Y');
                                            ?>   <?php echo $bank_name; ?> within 15 days from 
                                            the date of Booking 
                                        </li>
                                        <li>
                                            That 50% of the cost i.e. Rs.<input type="hidden" id="bookingAmountthree" value="<?php echo $Electrical_Work; ?>"><?php echo $Electrical_Work; ?>(Rupees <span id='wordbookingAmountthree' style="height:20px; width:auto; font-weight:bold;"></span> only/-)  is payable within 45 days from the 
                                            date of the Booking. 
                                        </li>
                                        <li>
                                            That 30%  of the cost i.e. Rs.<input type="hidden" id="bookingAmountfour" value="<?php echo $Sewer_Line_Network; ?>"><?php echo $Sewer_Line_Network; ?>(Rupees <span id='wordbookingAmountfour' style="height:20px; width:auto; font-weight:bold;"></span> only/-) is payable within 75 days from the date of the Booking. 
                                        </li>
                                        <li>
                                            That 10% (Balance Full & Final payment) of the cost i.e. Rs. <input type="hidden" id="bookingAmountfive" value="<?php echo $WaterSupplyandGardenNetwork; ?>"><?php echo $WaterSupplyandGardenNetwork; ?>(Rupees <span id='wordbookingAmountfive' style="height:20px; width:auto; font-weight:bold;"></span> only/-) is payable at the time of execution of conveyance deed.  
                                        </li>
                                    ...
                                    <h5 style="text-align: center;"><strong>NOT APPLICABLE FOR PLOT SALE</strong></h5>
                                    <br>
...
//}
        ...
        <script>
            ...
            $(document).ready(function () {
                var totalCostOne = $('#bookingAmounttwo').val();
                $('#wordbookingAmounttwo').text(convertNumberToWords(totalCostOne));
            });
            $(document).ready(function () {
                var totalCostOne = $('#bookingAmountthree').val();
                $('#wordbookingAmountthree').text(convertNumberToWords(totalCostOne));
            });
            $(document).ready(function () {
                var totalCostOne = $('#bookingAmountfour').val();
                $('#wordbookingAmountfour').text(convertNumberToWords(totalCostOne));
            });
            $(document).ready(function () {
                var totalCostOne = $('#bookingAmountfive').val();
                $('#wordbookingAmountfive').text(convertNumberToWords(totalCostOne));
            });
            $(document).ready(function () {
                var totalCostOne = $('#bookingAmountsix').val();
                $('#wordbookingAmountsix').text(convertNumberToWords(totalCostOne));
            });
            $(document).ready(function () {
                var totalCostOne = $('#bookingAmountseven').val();
                $('#wordbookingAmountseven').text(convertNumberToWords(totalCostOne));
            });
        </script>
        <script>

...
<html>
 ...
 <?php
                    ...
                    foreach ($this->Payment_model->get_applinfo($idr) as $row) {
                        ...
                        <?php $total_amount1 = $row->total_amount; ?>
                        <?php $stages = $row->stages; ?>
                    ...
                    <?php } ?>
                      ...
                      foreach ($this->Payment_model->show_dues_info($data) as $row) {
                            $pay_amount = $row->amount1;
                            $dl_current_id = $row->id;
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input type="hidden" name="" value="<?php echo $pay_amount; ?>" /><br>
                                        <input type="text" name="amount_paid" value="<?php echo $total_amount1; ?>" />
                                        
                                        <input type="hidden" name="" value="<?php echo $pay_amount - $total_amount1; ?>" />
                                        <input type="hidden" name="invoice_id" value="<?php echo $idr; ?>" />
                                        ...
                                        <input type="hidden" name="other_charges" value="<?php echo $other_charges; ?>" />
                                      
                                        <input type="hidden" name="receipt_no" value="<?php echo $invoice_no; ?>" />
                                        <input type="hidden" name="stages" value="<?php echo $stages; ?>" />

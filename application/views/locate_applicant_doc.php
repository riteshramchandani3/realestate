    ...
    <body> 
                ...
                <div class="row">
                    <div class="panel panel-primary" id="panelsuccess" style="display: none;">
                        ...
                        <div class="panel-body" style="width:100%;overflow:auto; max-height:500px;">
                            <!--<form class="form-inline" action="<?php echo site_url('Documentation/applicant_doc'); ?>" method = "post">-->
        ...
        <script>
            $(document).ready(function () {
                $('#toppageheader').html('Upload Document');
                $("a:contains(Upload Document)").parent().addClass('active');
                $("a:contains(Upload Document)").parents().addClass('open');
            });
            ...
            function getres(arg)
            {
                ...
                } else
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('Documentation/getsearchwords'); ?>",
            ...
            function getallapplicants()
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('Documentation/allprojectdoc') ?>",
            ...
            function add_docs_for_this_applicant(uid) {
                window.location.href = 'add_appl_docs?uid=' + uid;
            }

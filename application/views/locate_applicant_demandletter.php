...
<html>
    <head>
        <title>Demand letter Search</title>
        <?php
        ...
        <script type="text/javascript">
            ...
            function getres(arg)
            {
                ...
                } else
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('Demand_letter/getsearchwords'); ?>",
            ...
            function getallapplicants()
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('Demand_letter/allprojectdoc') ?>",
            ...
            $(document).ready(function () {
                $('#toppageheader').html('Demand Letter Search');
                $("a:contains(Demand Letter)").parent().addClass('active');
                $("a:contains(Demand Letter)").parents().addClass('open');
            });

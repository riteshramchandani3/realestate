...
<html>
    ...
    <head>
        <title>Possession Set Work Completion</title>
        <?php
        ...
        <div class="main">
            ...
            <div id="printable">
                <div class="container">
                    ...
                    $present_addr = $dtl->present_addr;
                    $son_doughter_wife_mr_mrs = $dtl->son_doughter_wife_mr_mrs;
                    $swd_of = $dtl->swd_of;
                    $pin_code = $dtl->pin_code;
// print_r( $userid); 
                    foreach ($this->Search_all_form_model->get_completion_details($userid) as $row) {
                        ?> 
                    ...
                    <?php } else { ?>
                        <div class="container" style="width: 82%;">
                            <div class="alert alert-info text-center" role="alert">Please Fill the Work Completion Status</div>
                        </div>
                    <?php } ?>
                </div> 
            </div> 
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#toppageheader').html('Possession Set Work Completion<span class="pull-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="print" id="btnprint" value="print" class="btn btn-sm btn-default" onClick="print_this_doc();">Print&nbsp;&nbsp;<i class="fa fa-print"></i></button>');

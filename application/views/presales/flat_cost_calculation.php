            ...
            <div id="printable">
                <div class="container">
                    ...
                    <form class="form-inline" action="<?php echo site_url('pre_sales/get_visitor_Flat_Input'); ?>" method="post" autocomplete="off" name="Form"  onsubmit="return ValidationEvent()" > 
                        ...
                        foreach ($this->Pre_sales_model->getproject_dtls_flat($data) as $row) {
                            ?>
                           ...
                           <?php $wash_area = $row->wash_area; ?>
                            ...
                            <?php $total_sum_x = $unit_cost_carpet_result + $balcony_result1 + $balcony_2result; ?> 
                        <?php }
                        ?>
                        <?php
                        //  $data['plot_size_mtr'] = $plot_size_mtr;
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <?php echo $flat_carpet_area_sqmt; ?>    
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <?php echo number_format((float) $flat_carpet_area_sqft, 2, '.', ''); ?>

        ...
        <div class="main">
            ...
            <div id="printable">
                <div class="container">
                    ...
                    <form class="form-inline" action="<?php echo site_url('pre_sales/update_Phase1_duplexcost_cal_Input'); ?>" method="post" name="Form" enctype="multipart/form-data" onsubmit="return validateForm()">
                        <div id="printable">
                            <div class="container">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                Rs.  <input type="text" id="one" name="total_unit_cost_as_per_carpet_area" value="<?php echo number_format((float) $total_unit_cost_as_per_carpet_area, 2, '.', ''); ?>" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                Rs.   <input type="text" id="three" name="extra_charge" value="<?php echo number_format((float) $extra_charge, 2, '.', ''); ?>" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                Rs.   <input type="text" id="threetotal" value="<?php echo number_format((float) $land_cost, 2, '.', ''); ?>" name="construction_cost" onblur="makedecimal(this.id)" />   
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="four" value="<?php //echo number_format((float) $land_cost, 2, '.', ''); ?>" name="net_final_total_cost" onblur="makedecimal(this.id)" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="five" name="maintenance_cost_ref_rate" value="<?php echo number_format((float) $maintenance_cost_ref_rate, 2, '.', '');  ?>" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" value="<?php echo number_format((float) $MPSEB_system, 2, '.', '');  ?>" id="six" name="MPSEB_system" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="seven" value="<?php echo number_format((float) $namantaran, 2, '.', '');  ?>" name="namantaran" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="eight" value="<?php echo number_format((float) $registry_charges, 2, '.', '');  ?>" name="registry_charges" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" value="<?php echo number_format((float) $rcc_tower, 2, '.', '');  ?>" id="nine" name="rcc_tower" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="ten" value="<?php echo number_format((float) $total_open_terrace_area_back, 2, '.', '');  ?>" name="total_open_terrace_area_back" value="<?php // echo number_format((float) $terrace_back_price, 2, '.', '');  ?>" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="eleven" value="<?php echo number_format((float) $ac_point_at_ff, 2, '.', '');  ?>" name="ac_point_at_ff" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" value="<?php echo number_format((float) $discount, 2, '.', '');  ?>" id="thirteen" name="discount" onblur="makedecimal(this.id)" onkeyup="allinone();" />
                                            </td>

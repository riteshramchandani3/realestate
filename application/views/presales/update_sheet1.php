...
// echo $id;
                    ...
                    <form class="form-inline" action="<?php echo site_url('pre_sales/update_visitor_Input'); ?>" method="post" autocomplete="off" enctype="multipart/form-data"  >
...
<?php if ($type == 'Duplex') { ?>
                                            ...
                                            ?>
                                            <?php $length_m * $width_m; ?>
                                        <?php } else { ?>                

                                            <?php $plot_size_ft; ?>
                                        <?php } ?>
                                        <?php echo nbs(1); ?>  <?php echo number_format((float) $length_m, 2, '.', ''); ?><?php echo nbs(2); ?>X<?php echo nbs(2); ?><?php echo number_format((float) $width_m, 2, '.', ''); ?>
                                        <input type="hidden" value="<?php echo $plot_size_mtr ?>" name="plot_size_mtr" readonly/>
                                    </td>
                                    <td>
                                        &nbsp;Mtr
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input type="text" value="<?php echo number_format((float) $cost_carpet_area, 2, '.', ''); ?>"   readonly/>
                                    </td>
                                    <td>
                                        sqmt.
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input type="text" value="<?php echo number_format((float) $cost_carpet_area * 10.76, 2, '.', ''); ?>" name=""  readonly/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="Unit_Cost_as_per_carpet_area_size" name="cost_carpet_area" value="<?php echo number_format((float) $cost_carpet_area, 2, '.', ''); ?>" readonly/>
                                        <!--button type="button" class="btn btn-info btn-sm" id="btnEditarea"><i class="fa fa-edit"></i></button-->
                                    </td>
                                    <td>
                                        Rs.<input type="text" class="inputborder" onkeyup="calculate_Unit_Cost_as_per_carpet_area(this.value)" name="cost_ca_ref_rate" value="<?php echo number_format((float) $cost_ca_ref_rate, 2, '.', ''); ?>" readonly/>
<?php if ($urole == 'ADMIN' || $urole == 'MD') { ?>

                                            <button type="button" class="btn btn-info btn-sm" id="btnEditrate"><i class="fa fa-edit"></i></button>
<?php } ?>
                                    </td>
                            <input type="hidden" id='tencoma_unit_cost_as_per_carpet_rate' value="<?php echo round($cost_ca_ref_rate * 10.76, 2); ?>" readonly/>
                            <td>
                                10.76
                            </td>
                            <td>
                                Rs. <input type="text" title="Unit Cost as per carpet area * Unit Cost as per carpet area rate * 10.76" id="Unit_Cost_as_per_carpet_area_rate" name="total_unit_cost_as_per_carpet_area" value="<?php echo number_format((float) $total_unit_cost_as_per_carpet_area, 2, '.', ''); ?>" readonly/>

                                <input type="hidden" title="Unit Cost as per carpet area * Unit Cost as per carpet area rate * 10.76" id="Unit_Cost_as_per_carpet_area_rate_gst" value="<?php echo $gst_res1 = round((($cost_carpet_area * $cost_ca_ref_rate) * 10.76 ) * $result5 / 100, 2); ?>"  readonly/>  <!--  Hidden GST-1 -->
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="Coveres_Balcony_Area_size" name="cost_balcony_area" value="<?php echo number_format((float) $cost_balcony_area, 2, '.', ''); ?>" readonly/> 
                                </td>
                                <td>
                                    Rs.  <input type="text" class="inputborder" onkeyup="calculate_Coveres_Balcony_Area(this.value)" name="cost_balcony_ref_rate" value="<?php echo number_format((float) $cost_balcony_ref_rate, 2, '.', ''); ?>" readonly/> 

                                </td>
                            <input type="hidden" id='tencoma_balcony_area' value="<?php echo round($cost_balcony_ref_rate * 10.76, 2); ?>" readonly/>
                            <td>
                                10.76
                            </td>

                            <td>
                                Rs. <input type="text" title="Coveres Balcony Area * Coveres Balcony Area Rate * 10.76" id="Coveres_Balcony_Area_rate" name="total_balcony_area" value="<?php echo number_format((float) $total_balcony_area, 2, '.', ''); ?>" readonly/>

                                <input type="hidden" title="Coveres Balcony Area * Coveres Balcony Area Rate * 10.76" id="Coveres_Balcony_Area_rate_gst" value="<?php echo $gst_res2 = round((($cost_balcony_area * $cost_balcony_ref_rate) * 10.76 ) * $result5 / 100, 2); ?>" /> <!--  Hidden GST-2 -->
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="Open_Terrace_Area_Front_size" name="cost_open_terrace_area_front" value="<?php echo number_format((float) $cost_open_terrace_area_front, 2, '.', ''); ?>" readonly/> 
                                </td>
                                <td>
                                    Rs. <input type="text" class="inputborder" onkeyup="calculate_Open_Terrace_Area_Front(this.value)" name="cost_open_terrace_front_area_ref_rate" value=" <?php echo number_format((float) $cost_open_terrace_front_area_ref_rate, 2, '.', ''); ?>" readonly/> 

                                </td>
                            <input type="hidden" id='tencoma_open_terrance_front' value="<?php echo round($cost_open_terrace_front_area_ref_rate * 10.76, 2); ?>" readonly/>
                            <td>
                                10.76
                            </td>

                            <td>
                                Rs.    <input type="text" title="Open Terrace Area (Front) * Open Terrace Area Rate (Front) * 10.76" id="Open_Terrace_Area_Front_rate" name="total_open_terrace_area_front" value="<?php echo number_format((float) $total_open_terrace_area_front, 2, '.', ''); ?>" readonly/>

                                <input type="hidden" title="Open Terrace Area (Front) * Open Terrace Area Rate (Front) * 10.76" id="Open_Terrace_Area_Front_rate_gst" value="<?php echo $gst_res3 = round((($cost_open_terrace_area_front * $cost_open_terrace_front_area_ref_rate) * 10.76 ) * $result5 / 100, 2); ?>"/> <!--  Hidden GST-3 -->
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="Open_Terrace_Area_Back_size" name="cost_open_terrace_area_back" value="<?php echo number_format((float) $cost_open_terrace_area_back, 2, '.', ''); ?>" readonly/> 
                                </td>
                                <td>
                                    Rs.  <input type="text" class="inputborder" onkeyup="calculate_Open_Terrace_Area_Back(this.value)" name="cost_open_terrace_back_area_ref_rate" value="<?php echo number_format((float) $cost_open_terrace_back_area_ref_rate, 2, '.', ''); ?>" readonly/> 

                                </td>
                            <input type="hidden" id='tencoma_open_terrance_back' value="<?php echo round($cost_open_terrace_back_area_ref_rate * 10.76, 2); ?>" readonly/>
                            <td>
                                10.76
                            </td>

                            <td>
                                Rs. <input type="text" title="Open Terrace Area (Back) * Open Terrace Area Rate(Back) *10.76 " id="Open_Terrace_Area_Back_rate" name="total_open_terrace_area_back" value="<?php echo number_format((float) $total_open_terrace_area_back, 2, '.', ''); ?>" readonly/>

                                <input type="hidden" title="Open Terrace Area (Back) * Open Terrace Area Rate(Back) *10.76 " id="Open_Terrace_Area_Back_rate_gst" value="<?php echo $gst_res4 = round((($cost_open_terrace_area_back * $cost_open_terrace_back_area_ref_rate) * 10.76 ) * $result5 / 100, 2); ?>"/><!--  Hidden GST-4 -->
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="Car_Porch_Area_size" name="cost_car_poarch_area" value="<?php echo number_format((float) $cost_car_poarch_area, 2, '.', ''); ?>" readonly/>
                                </td>
                                <td>
                                    Rs.  <input type="text" class="inputborder" onkeyup="calculate_Car_Porch_Area(this.value)" name="cost_car_poarch_area_ref_rate" value="<?php echo number_format((float) $cost_car_poarch_area_ref_rate, 2, '.', ''); ?>" readonly/>

                                </td>
                            <input type="hidden" id='tencoma_car_porch_area' value="<?php echo round($cost_car_poarch_area_ref_rate * 10.76, 2); ?>" readonly/>
                            <td>
                                10.76
                            </td>

                            <td>
                                Rs.   <input type="text" title="Car Porch Area * Car Porch Area Rate * 10.76"  id="Car_Porch_Area_rate" name="total_car_poarch_area" value="<?php echo number_format((float) $total_car_poarch_area, 2, '.', ''); ?>" readonly/>

                                <input type="hidden" title="Car Porch Area * Car Porch Area Rate * 10.76"  id="Car_Porch_Area_rate_gst" value="<?php echo $gst_res5 = round((($cost_car_poarch_area * $cost_car_poarch_area_ref_rate) * 10.76 ) * $result5 / 100, 2); ?>"/> <!--  Hidden GST-5 -->
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="Wash_Area_G_F_size" name="cost_wash_area" value="<?php echo number_format((float) $cost_wash_area, 2, '.', ''); ?>" readonly/> 
                                </td>
                                <td>
                                    Rs. <input type="text" class="inputborder" onkeyup="calculate_Wash_Area_G_F(this.value)" name="cost_washarea_ref_rate" value="<?php echo number_format((float) $cost_washarea_ref_rate, 2, '.', ''); ?>" readonly/>

                                </td>
                            <input type="hidden" id='tencoma_wash_area' value="<?php echo round($cost_washarea_ref_rate * 10.76, 2); ?>" readonly/>
                            <td>
                                10.76
                            </td>

                            <td>
                                Rs. <input type="text" title="Wash Area G. F. * Wash Area G. F. Rate * 10.76" id="Wash_Area_G_F_rate" name="total_wash_area" value="<?php echo number_format((float) $total_wash_area, 2, '.', ''); ?>" readonly/>

                                <input type="hidden" title="Wash Area G. F. * Wash Area G. F. Rate * 10.76" id="Wash_Area_G_F_rate_gst" value="<?php echo $gst_res6 = round((($cost_wash_area * $cost_washarea_ref_rate) * 10.76 ) * $result5 / 100, 2); ?>"/> <!--  Hidden GST-6 -->
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Rs. <strong><input type="text" id="final_total" name="final_total" value="<?php echo number_format((float) $total_six, 2, '.', ''); ?>" readonly/></strong>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    Rs. <input type="text" name="gst" id="total1" value="<?php echo number_format((float) $gst, 2, '.', ''); ?>"  readonly/>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Rs. <input type="text" id="charge_amt" value="<?php echo number_format((float) $charge_amount, 2, '.', ''); ?>"  readonly />
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <textarea cols="3" rows="4" style="width:100%;" class="form-control" id="extra_charge_box" placeholder="Description" name="extra_charge_des"><?php echo $extra_charge_des; ?></textarea>
                                ...
                                <td>
                                    Rs. <input type="text" class="form-control" onblur="makethisdecimal(this.id);" onfocus="cleasdiscountpremium();" value="<?php echo number_format((float) $extra_charge, 2, '.', ''); ?>" name="extra_charge"  onkeyup="calculate_other_fix_charges(this.value)"  onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13 || event.charCode == 46) ? null : event.charCode >= 48 && event.charCode <= 57" id="other_charges"  />
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <textarea cols="3" rows="4" style="width:100%;" class="form-control" id="premium_location_charges_box" placeholder="Description" name="premium_location_charges_des"><?php echo $premium_location_charges_des; ?></textarea>
                            ...
                            <tr>
                                ...
                                <td>
                                    Rs. <b><input type="text" id='Cost_payable_to_company' name="cost_payble" title="'Total + GST + Other Fix Charges + Maintainance 5 Years + Premium location charges'" value="<?php echo $cost_pay = number_format((float) $cost_payble_to_company, 2, '.', ''); ?>"  readonly/></b>

                                    <input type="hidden"  id="cost_payable_to_com" value="<?php echo $cost_pay = round($cost_payble_to_company, 2); ?>" readonly/>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Rs. <input onfocus="clearabovetwo();"  onblur="makethisdecimal(this.id);" type="text" min="1" step="1" class="form-control"  value="<?php echo number_format((float) $discount, 2, '.', ''); ?>" onkeyup="calculate_discount(this.value)" id="discount" name="discount" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13 || event.charCode == 46) ? null : event.charCode >= 48 && event.charCode <= 57"/>
                                </td>
                            </tr>
                            <script>
                            ...
                            <tr>
                                ...
                                <td>
                                    Shall be Born by allotee
                                </td>
                                <td>
                                    <strong><input type="text" name="total_cost" id="total_cost"   value="<?php echo number_format((float) $total_cost1, 2, '.', ''); ?>" readonly/></strong>
                                </td>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                &nbsp;<textarea cols="3" rows="5" style="width:100%;" id="discussion" name="discussion" class="form-control"> <?php echo $discussion; ?></textarea>
                            </div>
                        </div>
                        <br>

        ...
        <div class="main">
            ...
            <div id="printable">
                <div class="container">
                    ...
                    <form class="form-inline" action="<?php echo site_url('pre_sales/get_visitor_Input1'); ?>" method="post" name="Form" enctype="multipart/form-data" onsubmit="return validateForm()">
                        <div id="printable">
                            <div class="container">
                                <?php
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="basic_cost_ref_rate" id="basic_cost" onblur="makedecimal(this.id);"  value="<?php echo number_format((float) $basic_cost_ref_rate * $plot_sqft, 2, '.', ''); ?>" style="width:100%; border: none;" readonly/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="plot_cost" onblur="makedecimal(this.id);" value="<?php echo number_format((float) $basic_cost_ref_rate * $plot_sqft, 2, '.', ''); ?>" style="width:100%; border: none;" readonly/>
                                        </td>
...
<?php
                                            ...
                                            foreach ($this->Pre_sales_model->getfacing_charges($unit_no) as $row) {
                                                ?>
                                                <?php  $facing_charges = $row->facing; ?>
                                            <?php 
                                        ...
                                        <td>
                                            <input type="text" id="corner_charges" name="corner_charges" onblur="makedecimal(this.id);" value="<?php echo number_format((float) $facing_charges , 2, '.', ''); ?>" style="width:100%; border: none;" readonly/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="garden_facing_charges" name="garden_facing_charges" onblur="makedecimal(this.id);" value="<?php echo number_format((float) $garden_facing_charges = $basic_cost_ref_rate * $plot_sqft * 5 / 100, 2, '.', ''); ?>" style="width:100%; border: none;" readonly/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="total_cost_of_unit"  onblur="makedecimal(this.id)" onkeyup="allinone();" value="<?php echo number_format((float) $facing_charges + $garden_facing_charges + $basic_cost_ref_rate * $plot_sqft, 2, '.', ''); ?>" style="width:100%;" readonly/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="mpseb_charges" name="mpseb_cost_ref_rate" onblur="makedecimal(this.id)" onkeyup="allinone();" value="<?php echo $mpseb_cost_ref_rate; ?>" style="width:100%;" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="water_connection_ref_rate" style="width:100%;" id="water_connection"  onblur="makedecimal(this.id)" onkeyup="allinone();" value="<?php echo $water_connection_ref_rate; ?>" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="maintenance_cost_ref_rate" id="maintanace_charges" style="width:100%;" onblur="makedecimal(this.id)" onkeyup="allinone();" name="$maintenance_cost_ref_rate"  value="<?php echo $maintenance_cost_ref_rate; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text"  name="cost_pay" id="cost_pay" style="width:100%; border: none;" readonly/>
                                        </td>
                                    </tr>
                                    <!--tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" onblur="makedecimal(this.id)" onkeyup="allinone();"  id="discount" name="discount" onfocus="clearabovetwo();" style="width:100%;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <span>+Registry + Society + <span class="pull-right"> Rs.</span><br>Monthly Operational Charges + Mutation</span>

                                        </td>
                                        <td>
                                            <input type="text" name="net_final_total_cost" id="net_final_total_cost" style="width:100%; border: none;" readonly />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="7">

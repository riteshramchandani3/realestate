        ...
        <div class="main">
                    ...
                    <div class="panel with-nav-tabs panel-primary">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab1default" data-toggle="tab">Create Invoice</a></li>
                                <li><a href="#tab2default" data-toggle="tab">View Invoice</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="tab-pane fade in active" id="tab1default">
                            <div class="panel panel-primary">
                                        ...
                                        <form class="form-inline"> 
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div id="stage">
                                                        <div class="form-group" id="stage" style="display: block;">
                                                            <div class="col-xs-2"><label for="stage">Stage Amount:</label></div>
                                                            <div class="col-xs-5 ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-5 ">
                                                        <div class="input-group">
                                                            <input type="text" name="chq_submit_date" class="form-control" id="date"  />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-5 ">
                                                        ...
                                                        <input type='number' id="pay" step="0.01" name="amount_paid"  onkeyup="calculate(this.value)" onblur="word.innerHTML = convertNumberToWords(this.value)" class="form-control" required/>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                ...
                                                <div class="row" id="show" style="display:block;">
                                                    ...
                                                    <div class="col-xs-5 ">
                                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="drawn_on" name="drawn_on">
                                                            <option  value="">--Select--</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-5 ">
                                                        <input type="number" class="form-control" name="payment_mode_no" size="38"  placeholder=""  size="30"  required/>
                                                    </div>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                    $('#toppageheader').html('Invoices');
                                    $("a:contains(Invoices)").parent().addClass('active');
                                    $("a:contains(Invoices)").parents().addClass('open');
                                    });
                                </script>
                            </div>
            ...
            //$('#drawn_on').prop("disabled", false);
                   ...
                   $('#show').show();
                    ...
                    $('#toppageheader').html('Invoice & Payment <span class="pull-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="print" id="btnprint" value="print" class="btn btn-sm btn-default" onClick="print_this_doc();">Print&nbsp;&nbsp;<i class="fa fa-print"></i></button></span>');
